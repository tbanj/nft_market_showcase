...
function App() {
  return (
    ...
    />
     ...
     <SectionWrapper
      title="Deployment"
      description="ProfNef is built using Expo
    ...
    <SectionWrapper
      ...
      description="The app contains two screens. The first screen list all
    ...
    flex-col text-center banner04'>
      ...
      <span className='bold'>Alabi Wahab Temitope</span>
