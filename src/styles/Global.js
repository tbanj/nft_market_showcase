const styles = {
    ...
    pText:
      "my-5 min md:my-10 font-IBMPlex font-light text-xl minmd:text-3xl minlg:text-4xl minmd:leading-16",
    descriptionText:
      "my-5 min md: font-IBMPlex font-light text-xl minmd:text-3xl minlg:text-4xl minmd:leading-16",
